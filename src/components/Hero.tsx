...
const slides = [
  {
    ...
    thumbnail: 'https://darkblue-pony-385649.hostingersite.com/wp-content/uploads/2025/11/slider2.png'
  },
  {
    image: 'https://darkblue-pony-385649.hostingersite.com/wp-content/uploads/2025/11/slider5.png',
    thumbnail: 'https://darkblue-pony-385649.hostingersite.com/wp-content/uploads/2025/11/slider5.png'
  },
  {
    image: 'https://darkblue-pony-385649.hostingersite.com/wp-content/uploads/2025/11/slider3.png',
    thumbnail: 'https://darkblue-pony-385649.hostingersite.com/wp-content/uploads/2025/11/slider3.png'
  }
];
            ...
            <div className="text-white space-y-3 sm:space-y-4 lg:space-y-5">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <a
                    href="tel:4102907136"
                    className="bg-gradient-to-r from-amber-500/20 to-amber-600/20 backdrop-blur-sm px-4 py-2 rounded-lg border border-amber-500/30 text-center hover:from-amber-500/30 hover:to-amber-600/30 transition-all"
                  >
                    <p className="text-xs sm:text-sm font-medium text-amber-400">(410) 290-7136</p>
                  </a>
                  <a
                    href="mailto:office@granix.com"
                    className="bg-gradient-to-r from-amber-500/20 to-amber-600/20 backdrop-blur-sm px-4 py-2 rounded-lg border border-amber-500/30 text-center hover:from-amber-500/30 hover:to-amber-600/30 transition-all"
                  >
                    <p className="text-xs sm:text-sm font-medium text-amber-400">office@granix.com</p>
                  </a>
                </div>
              </div>
