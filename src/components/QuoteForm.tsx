...
export function QuoteForm({ variant = 'section', onClose, onSubmitSuccess }: QuoteFormProps) {
  ...
  const formClasses = isModal
    ...
    : isHero
    ? 'bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-2xl'
    ...
    <div className={formClasses}>
      ...
      <div className="mb-4 sm:mb-6">
        ...
        <p className="text-amber-600 text-base sm:text-lg">
          25% OFF All <span className="font-bold">High-End Countertops!</span>
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          <div>
            <input
              ...
              required
              className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 border-gray-200 rounded-lg focus:border-amber-500 focus:outline-none transition-colors text-sm sm:text-base"
            />
          </div>
          ...
          <div>
            <input
              ...
              required
              className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border-2 rounded-lg focus:outline-none transition-colors text-sm sm:text-base ${
                emailError
          ...
          <div>
            ...
            <label
              htmlFor="file-upload"
              className="w-full flex items-center justify-center gap-2 px-3 sm:px-4 py-2.5 sm:py-3 border-2 border-dashed border-gray-300 rounded-lg hover:border-amber-500 transition-colors cursor-pointer text-sm sm:text-base text-gray-600 hover:text-amber-600"
            >
              <Upload size={20} />
              <span>Attach Files (Optional, Max 20MB)</span>
            </label>
            {selectedFile && (
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold py-3 sm:py-4 rounded-lg hover:from-amber-600 hover:to-amber-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg text-sm sm:text-base animate-pulse-scale flex items-center justify-center gap-2"
          >
            <Send size={20} />
            <span>{isSubmitting ? 'Submitting...' : 'GET MY 25% OFF QUOTE NOW'}</span>
          </button>
